...
const sendForgotPasswordEmail = async (email) => {
  ...
  let info = await transporter.sendMail({
    ...
    <a href="https://Orbitalcopytrading.com/reset-password">
    reset password
    </p>
...
const sendVerificationEmail = async ({ from, url }) => {
  ...
  let info = await transporter.sendMail({
    ...
    <p>${from} just verified his Orbitalcopytrading Team Identity
    </p>
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `
    <html>
    <h2>Welcome to Orbitalcopytrading</h2>
...
//'<a href="https://Orbitalcopytrading.com/Orbitalcopytrading.com/verified.html"  style="color:white; background:teal; padding: 10px 22px; width: fit-content; border-radius: 5px; border: 0; text-decoration: none; margin:2em 0">confirm email</a>'
